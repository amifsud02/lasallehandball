                    ...
                    <div className="parent">
                        <div className="page-content">
                            <div className="page-content-header">
                                <div className="page-content-header-title title">Club History</div>
                            </div>
                            <div className="page-content-body">
                                <div className="page-content-body-text">
                                    ...
                                    <span>
                                        <li>Fostering interest in, and knowledge about Handball at De La Salle College.</li>
                                        <li>Developing a solid and permanent youth nursery for the benefit of De La Salle College students.</li>
                                        <li>Preparing teams for participation in friendly and competitive Handball matches, leagues and tournaments organised both locally and abroad.</li>
                                        <li>Organising any other activity that is conducive to the development and promotion of the game of Handball.</li>
                                    </span>
